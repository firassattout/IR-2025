...
def build_bm25_model(collection_name, model_path, vector_path):
    """
    بناء نموذج BM25 وحفظ النموذج والمتجهات.
    Args:
        collection_name (str): اسم المجموعة في MongoDB.
        model_path (str): مسار حفظ نموذج BM25.
        vector_path (str): مسار حفظ متجهات الوثائق.
    """
